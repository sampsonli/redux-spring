...
exports.autowired = exports.Model = exports.resource = exports.inject = exports.resetModel = exports.useModel = exports.service = void 0;
...
function assign(target, from) {
    // @ts-ignore
    if (Object.assgin)
        return Object.assign.apply(Object, arguments); // 现代浏览器赋值
...
function service(ns) {
    return function (Clazz) {
        ...
        var prototype = { ns: ns, setData: undefined, reset: undefined, created: undefined };
        var _prototype = { ns: ns, setData: undefined, reset: undefined };
        ...
        prototype.setData = function (props) {
            ...
            if (keys.some(function (key) { return props[key] !== state[key]; })) {
                _store.dispatch({ type: "spring/" + ns, payload: __assign(__assign({}, state), props) });
            }
        };

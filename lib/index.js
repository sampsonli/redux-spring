...
exports.Model = exports.resource = exports.inject = exports.useModel = exports.service = void 0;
        ...
        Object.getOwnPropertyNames(Clazz.prototype).forEach(function (key) {
            if (key !== 'constructor' && typeof Clazz.prototype[key] === 'function') {
                ...
                prototype[key] = function () {
                    ...
                    if (util_1.isGenerator(origin_1)) { // 如果当前方法是generator方法
                ...
                if (util_1.isGenerator(origin_1)) { // 解决异步方法嵌套调用问题

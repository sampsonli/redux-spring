        ...
        var Result = function () {
            ...
            function doUpdate(newState) {
                ...
                if (diff) {
                    ...
                    var diff_1 = wiredList.some(function (key) { return newState[key] !== rootState[__wired[key]]; });
                    if (diff_1) {
                        _store.dispatch({ type: "spring/" + ns, payload: newState });
                    }
                }
            ...
            var reducer = function (state, _a) {
                ...
                if (type === "spring/" + ns) {
                    ...
                    var result_1 = Object.create(prototype);
                    assign(result_1, payload);
                    wiredList.forEach(function (key) {
                        result_1[key] = rootState_1[__wired[key]];
                    });
                    return result_1;
                }
                return state;
